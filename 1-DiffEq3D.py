...
w_rec_x_t0_no_term = ((w_t0[:, col_lr_r, dep_lr_r]*(weight_row_lr_r * weight_col_lr_r * weight_dep_lr_r))+\
                                  ...
                                  (w_t0[:, col_lr_r, dep_lr_r]*(weight_row_up_r * weight_col_lr_r * weight_dep_lr_r))+\
                                      (w_t0[:, col_lr_r, dep_up_r]*(weight_row_up_r * weight_col_lr_r * weight_dep_up_r))+\
                                          (w_t0[:, col_up_r, dep_lr_r]*(weight_row_up_r * weight_col_up_r * weight_dep_lr_r))+\
                                              (w_t0[:, col_up_r, dep_up_r]*(weight_row_up_r * weight_col_up_r * weight_dep_up_r)))#-(Ws/(4*math.pi*Dx[:,0,0]*dist_x)))
...
w_rec_x_t0_correction = ((w_t0[:, col_lr_r, dep_lr_r]*(weight_row_lr_r * weight_col_lr_r * weight_dep_lr_r))+\
                      (w_t0[:, col_lr_r, dep_up_r]*(weight_row_lr_r * weight_col_lr_r * weight_dep_up_r))+\
                          (w_t0[:, col_up_r, dep_lr_r]*(weight_row_lr_r * weight_col_up_r * weight_dep_lr_r))+\
                              (w_t0[:, col_up_r, dep_up_r]*(weight_row_lr_r * weight_col_up_r * weight_dep_up_r))+\
                                  (w_t0[:, col_lr_r, dep_lr_r]*(weight_row_up_r * weight_col_lr_r * weight_dep_lr_r))+\
...
w_rec_x_35dB = ((w_35dB[:, col_lr_r, dep_lr_r]*(weight_row_lr_r * weight_col_lr_r * weight_dep_lr_r))+\
            (w_35dB[:, col_lr_r, dep_up_r]*(weight_row_lr_r * weight_col_lr_r * weight_dep_up_r))+\
                (w_35dB[:, col_up_r, dep_lr_r]*(weight_row_lr_r * weight_col_up_r * weight_dep_lr_r))+\
                    (w_35dB[:, col_up_r, dep_up_r]*(weight_row_lr_r * weight_col_up_r * weight_dep_up_r))+\
                        (w_35dB[:, col_lr_r, dep_lr_r]*(weight_row_up_r * weight_col_lr_r * weight_dep_lr_r))+\
                            (w_35dB[:, col_lr_r, dep_up_r]*(weight_row_up_r * weight_col_lr_r * weight_dep_up_r))+\
                                (w_35dB[:, col_up_r, dep_lr_r]*(weight_row_up_r * weight_col_up_r * weight_dep_lr_r))+\
                                    (w_35dB[:, col_up_r, dep_up_r]*(weight_row_up_r * weight_col_up_r * weight_dep_up_r)))#-(Ws/(4*math.pi*Dx*dist_x)))    

spl_rec_35dB = 10*np.log10(rho*c0**2*abs(w_rec_x_35dB)/pRef**2)
...
#SAVING
###############################################################################
np.save(os.path.join('results_diff_imp','spl_r_off'),spl_r_off)
np.save(os.path.join('results_diff_imp','spl_r_off_diff'),spl_r_off_diff)
np.save(os.path.join('results_diff_imp','spl_rec_x_t0'),spl_rec_x_t0)
np.save(os.path.join('results_diff_imp','spl_stat_x_t0'),spl_stat_x_t0)
np.save(os.path.join('results_diff_imp','spl_rec_x_t0_correction'),spl_rec_x_t0_correction)
np.save(os.path.join('results_diff_imp','spl_rec_35dB'),spl_rec_35dB)
np.save(os.path.join('results_diff_imp','D_th'),D_th)
np.save(os.path.join('results_diff_imp','alpha'),alpha_1)
np.save(os.path.join('results_diff_imp','c0'),c0)
np.save(os.path.join('results_diff_imp','RT_Sabine'),RT_Sabine)
np.save(os.path.join('results_diff_imp','x_axis'),x)
np.save(os.path.join('results_diff_imp','t_off'),t[idx_w_rec:])
np.save(os.path.join('results_diff_imp','length.npy'),length)
np.save(os.path.join('results_diff_imp','width.npy'),width)
np.save(os.path.join('results_diff_imp','height.npy'),height)
np.save(os.path.join('results_diff_imp','x_source.npy'),x_source)
np.save(os.path.join('results_diff_imp','y_source.npy'),y_source)
np.save(os.path.join('results_diff_imp','z_source.npy'),z_source)
np.save(os.path.join('results_diff_imp','x_rec.npy'),x_rec)
np.save(os.path.join('results_diff_imp','y_rec.npy'),y_rec)
np.save(os.path.join('results_diff_imp','z_rec.npy'),z_rec)
np.save(os.path.join('results_diff_imp','mean_free_path'),mean_free_path)